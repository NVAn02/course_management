<template>
    <div class="course-detail container-fluid pb-5 mb-5" style="margin-top: 3% ">
        ...
        <div class="header d-flex align-items-center  mt-4" style="width: 100%;">
            <div class="col-7 ml-5" style="text-align: left;">
                ...
                <div class="last-update mt-3" style="font-size: smaller;"><i class="far fa-calendar-check"></i> Lần cập
                    nhật gần đây nhất
                    {{created}}
                </div>
            </div>
