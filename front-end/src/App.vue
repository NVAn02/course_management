<template>
  ...
  <div class="d-flex ">
    <div v-if="isAdmin" class="col-2 " style="position: relative; left: -1%;">
...
<script>
  ...
  import AdminSideBar from './/views/admin-content/AdminSideBar';
...
<style>
  ...
  th {
   ...
   table {
        border-collapse: collapse; /* Đảm bảo các ô trong bảng không tạo khoảng trắng */
    }
    table, th, td {
        border: none; /* Bỏ viền cho bảng, ô tiêu đề, và ô dữ liệu */
    }
</style>