...
public class ClassServiceImpl implements ClassService{
    ...
    @Autowired
    public ClassServiceImpl(CourseClassRepository courseClassRepository, CourseRepository courseRepository, UserRepository userRepository, CourseRegisterRepository courseRegisterRepository, ScoreRepository scoreRepository, TeacherRepository teacherRepository, ModelMapper mapper) {
